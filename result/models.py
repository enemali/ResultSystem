...
class assessment(models.Model):
    ...
    firstCa = models.FloatField(default=0 , validators=[MaxValueValidator(20) , MinValueValidator(0)])
    secondCa = models.FloatField(default=0 , validators=[MaxValueValidator(20) , MinValueValidator(0)])
    exam = models.FloatField(default=0 , validators=[MaxValueValidator(100) , MinValueValidator(0)])
